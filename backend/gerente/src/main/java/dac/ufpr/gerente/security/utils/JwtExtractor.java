package dac.ufpr.gerente.security.utils;
...
public class JwtExtractor {
    ...
    public Optional<String> getAuthenticatedRole() {
        return getClaimValue("role", String.class);
    }

    public Optional<String> getAuthenticatedCpf() {
        return getClaimValue("cpf", String.class);
    }

    public <T> Optional<T> getClaimValue(String claimName, Class<T> type) {
        return getAllClaims().map(claims -> claims.get(claimName, type));
    }
