  ...
  inicializarBanco(): Observable<any> {
    return new Observable<any>((observer) => {
      ...
      const contaCatharyna: Conta = {
        ...
        historico: [
          {
            dataHora: "2020-01-01T10:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 1000,
          },
          {
            dataHora: "2020-01-01T11:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 900,
          },
          ...
          {
            dataHora: "2020-01-10T15:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 2000,
          },
      ...
      const contaCleuddonio: Conta = {
        ...
        historico: [
          ...
          {
            dataHora: "2025-01-02T10:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 5000,
          },
          { dataHora: "2025-01-10T10:00:00-03:00", tipo: "SAQUE", valor: 200 },
          {
            dataHora: "2025-02-05T10:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 7000,
          },
        ],
      ...
      const contaCatianna: Conta = {
        ...
        historico: [
          {
            dataHora: "2025-05-05T12:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 1000,
          },
      ...
      const contaCutardo: Conta = {
        ...
        historico: [
          {
            dataHora: "2025-06-01T12:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 150000,
          },
        ],
      ...
      const contaCoandrya: Conta = {
        ...
        historico: [
          {
            dataHora: "2025-07-01T12:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 1500,
          },
        ],
      ...
      const contaBruna: Conta = {
        ...
        historico: [
          {
            dataHora: "2024-03-01T09:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 1000,
          },
          { dataHora: "2024-03-01T14:00:00-03:00", tipo: "SAQUE", valor: 200 },
          {
            dataHora: "2024-03-05T11:30:00-03:00",
            tipo: "DEPOSITO",
            valor: 800,
          },
          {
      ...
      const contaDiego: Conta = {
        ...
        historico: [
          ...
          {
            dataHora: "2025-02-01T10:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 1500,
          },
      ...
      const contaElton: Conta = {
        ...
        historico: [
          {
            dataHora: "2025-03-01T09:15:00-03:00",
            tipo: "DEPOSITO",
            valor: 2000,
          },
      ...
      const contaFabiana: Conta = {
        ...
        historico: [
          ...
          {
            dataHora: "2025-03-20T10:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 400,
          },
        ],
      ...
      const contaHelena: Conta = {
        ...
        historico: [
          {
            dataHora: "2025-04-01T08:00:00-03:00",
            tipo: "DEPOSITO",
            valor: 300,
          },
