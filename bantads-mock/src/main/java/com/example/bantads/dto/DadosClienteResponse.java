...
public class DadosClienteResponse {
    ...
    public String getGerente_nome() { return gerente_nome; }
    public void setGerente_nome(String gerente_nome) { this.gerente_nome = gerente_nome; }
    public String getGerente_email() { return gerente_email; }
    public void setGerente_email(String gerente_email) { this.gerente_email = gerente_email; }
}
